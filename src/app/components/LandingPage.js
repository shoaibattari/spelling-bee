...
import { categories, spellingBeeData } from "@/app/constant/data";
...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-[url('/bg.jpeg')] bg-cover bg-cente bg-no-repeat bg-linear-to-br from-yellow-50 to-white">
      {/* HERO */}
      <section className="max-w-6xl mx-auto px-2 md:px-6 py-10 text-center">
        ...
        <div className="mt-10 flex justify-center gap-4 flex-wrap">
          <Link
            href="/all"
            className="px-6 py-3  w-full md:w-fit bg-yellow-500 hover:bg-yellow-600 cursor-pointer text-white rounded-xl transition"
          >
            View All Students
          </Link>
          ...
          <Link
            ...
            className="px-6 py-3 border  w-full md:w-fit bg-white border-yellow-500 rounded-xl hover:bg-yellow-500 hover:text-white transition cursor-pointer"
          >
            Browse Categories
          </Link>
          ...
          <Link
            href="/rules"
            className="px-6 py-3 bg-yellow-500  w-full md:w-fit hover:bg-yellow-600 cursor-pointer text-white rounded-xl transition"
          >
            View Rules
          </Link>
        </div>
      ...
      {/* CATEGORY GRID */}
      <section className="max-w-6xl mx-auto px-2 md:px-6 pb-20">
